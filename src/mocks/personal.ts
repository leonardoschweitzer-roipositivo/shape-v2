...
export const mockPersonalAthletes: PersonalAthlete[] = [
    { id: 'athlete-leonardo', name: 'Leonardo Schiwetzer', email: 'leonardo@email.com', gender: 'MALE', avatarUrl: null, score: 90.8, scoreVariation: 15.2, ratio: 1.58, lastMeasurement: '2026-02-09', status: 'active', linkedSince: '2024-01-01', assessments: [leo_current, leo_hist_1, leo_hist_2] },
