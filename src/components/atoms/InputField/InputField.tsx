...
export const InputField: React.FC<InputFieldProps> = ({
    ...
    <div className={`flex flex-col gap-1.5 ${className || ''}`}>
        ...
        <div className="relative group">
            <input
                type="number"
                className="w-full bg-background-dark border border-white/10 rounded-lg px-4 py-2 text-white placeholder-gray-600 focus:outline-none focus:border-primary/50 transition-colors text-sm font-mono disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-background-dark/50"
