                    ...
                    <div className="animate-fade-in-up">
                        <div className="bg-surface border border-white/10 rounded-2xl p-6 md:p-8 hover:border-primary/20 transition-all">
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-3 h-14 bg-primary text-white rounded-xl font-bold text-sm uppercase tracking-wider shadow-[0_0_20px_rgba(79,70,229,0.2)] hover:shadow-[0_0_30px_rgba(79,70,229,0.4)] transition-all hover:scale-[1.02] active:scale-[0.98]"
                            >
                                <Play size={18} />
