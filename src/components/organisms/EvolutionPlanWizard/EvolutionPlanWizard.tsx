        ...
        <div className="flex flex-col items-center text-center gap-6 py-8 animate-fade-in">
            ...
            <button
                ...
                className={`flex items-center gap-3 px-8 py-4 rounded-xl font-bold text-sm uppercase tracking-wider transition-all ${isGenerating
                    ...
                    : 'bg-primary text-black shadow-[0_0_20px_rgba(0,201,167,0.3)] hover:shadow-[0_0_30px_rgba(0,201,167,0.5)] hover:scale-105 active:scale-95'
                    }`}
            >
                {isGenerating ? (
                    <>
        ...
        <div className="fixed inset-0 z-50 bg-backdrop/95 backdrop-blur-md flex flex-col animate-fade-in">
            ...
            <div className="flex items-center justify-between px-6 py-4 border-t border-white/5 bg-backdrop/80">
                ...
                {hasGenerated && (
                    <button
                        onClick={handleNext}
                        className="flex items-center gap-2 px-6 py-2.5 rounded-xl bg-primary text-black font-bold text-xs uppercase tracking-wider shadow-[0_0_15px_rgba(0,201,167,0.3)] hover:shadow-[0_0_25px_rgba(0,201,167,0.5)] transition-all hover:scale-105 active:scale-95"
                    >
                        {isLast ? (
                            <>
                                <Check size={16} />
