        ...
        <GlassPanel className="rounded-2xl p-1 relative flex flex-col items-center justify-center min-h-[300px]" hoverEffect={false}>
            ...
            <div className="relative w-48 h-48 flex items-center justify-center">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <span style={{ fontSize: typography.fontSize['3xl'], fontWeight: typography.fontWeight.bold, color: colors.text.primary, letterSpacing: typography.letterSpacing.tight }}>{typeof score === 'number' ? score.toFixed(1).replace('.0', '') : score}</span>
