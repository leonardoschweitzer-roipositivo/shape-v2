...
import { ArrowLeft, Search, Dumbbell, Video, X } from 'lucide-react'
...
export function BibliotecaExerciciosPage({ onBack }: BibliotecaExerciciosPageProps) {
...
const ExercicioCard: React.FC<ExercicioCardProps> = ({ exercicio, onClick }) => {
    ...
    return (
        <button
            ...
            onClick={onClick}
            className="group w-full text-left bg-white/[0.03] hover:bg-white/[0.06] border border-white/5 hover:border-white/10 rounded-xl p-4 transition-all duration-200 flex flex-col gap-3"
        >
