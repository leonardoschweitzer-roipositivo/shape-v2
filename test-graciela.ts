import fs from 'fs';
import { buildDiagnosticoPrompt } from './src/services/vitruviusPrompts';
import { perfilParaTexto, diagnosticoParaTexto, getFontesCientificas } from './src/services/vitruviusContext';
import { GoogleGenerativeAI } from '@google/generative-ai';
import { gerarDiagnosticoCompleto } from './src/services/calculations/diagnostico';
...
const input = {
    ...
    proporcoesPreCalculadas: [
        { grupo: 'Ampulheta', atual: 1.1, ideal: 1.2, pct: 90, status: 'META' },
        { grupo: 'Hip-Thigh Ratio', atual: 1.1, ideal: 1.2, pct: 90, status: 'META' }
    ]
};
